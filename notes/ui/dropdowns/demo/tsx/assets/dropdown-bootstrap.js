...
async function loadSharedTailwind() {
	...
	await new Promise((resolve, reject) => {
		...
		script.onerror = () => reject(/* @__PURE__ */ new Error("Could not load Tailwind browser runtime."));
		document.head.append(script);
	});
}
await loadSharedTailwind();
await __vitePreload(() => import("./dropdown-demo.js"), [], import.meta.url);
//#endregion
